...
// void LiveIntervals::intervalMBBs(const LiveInterval &LI, SmallVectorImpl<MachineBasicBlock *> &MBBs) const {
//   // Return the associate machine basic blocks the live interval is contained
//   // in
//   findLiveInMBBs(LI.beginIndex(), LI.endIndex(), MBBs);
// }
